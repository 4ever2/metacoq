...
then
    ...
    then
        ...
        UTILS_DEPS="-R ../bytestring/theories Bytestring"
        ...
        PLUGIN_DEMO_DEPS="-R ../../bytestring/theories Bytestring -R ../../utils/theories MetaRocq.Utils -R ../../common/theories MetaRocq.Common -R ../../template-rocq/theories MetaRocq.Template -I ../../template-rocq/  -I ../../erasure-plugin/src -I ../../safechecker-plugin/src/"
    ...
    echo "# DO NOT EDIT THIS FILE: autogenerated from ./configure.sh" > utils/metarocq-config
    ...
    echo ${UTILS_DEPS} >> utils/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} >> common/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${TEMPLATE_COQ_DEPS} >> template-rocq/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} >> pcuic/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} ${SAFECHECKER_DEPS} >> safechecker/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} ${TEMPLATE_PCUIC_DEPS} >> template-pcuic/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} ${TEMPLATE_PCUIC_DEPS} ${QUOTATION_DEPS} >> quotation/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} ${TEMPLATE_PCUIC_DEPS} ${SAFECHECKER_PLUGIN_DEPS} >> safechecker-plugin/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} ${SAFECHECKER_DEPS} ${ERASURE_DEPS} >> erasure/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} ${ERASURE_DEPS} ${TEMPLATE_PCUIC_DEPS} ${ERASURE_PLUGIN_DEPS} >> erasure-plugin/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} ${TRANSLATIONS_DEPS} >> translations/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} ${SAFECHECKER_DEPS} ${TEMPLATE_PCUIC_DEPS} ${ERASURE_DEPS} ${TRANSLATIONS_DEPS} ${ERASURE_PLUGIN_DEPS} ${EXAMPLES_DEPS} >> examples/metarocq-config
    echo ${UTILS_DEPS} ${COMMON_DEPS} ${PCUIC_DEPS} ${SAFECHECKER_DEPS} ${TEMPLATE_PCUIC_DEPS} ${ERASURE_DEPS} ${TRANSLATIONS_DEPS} ${ERASURE_PLUGIN_DEPS} ${TEST_SUITE_DEPS} >> test-suite/metarocq-config
